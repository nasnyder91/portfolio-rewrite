...
var _animations = __webpack_require__(330);
...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    key: 'changeJumbotronState',
    value: function changeJumbotronState(state, callback) {
      var _this = this;

      if (state === 'code') {
        _animations.animation.fadeOutElement(this.jumboText, 1000, function () {
          _this.jumboText.className = '';
          callback();
        });
      }
      if (state === 'html') {
    ...
    key: 'changeMainDisplayState',
    value: function changeMainDisplayState(state, data) {
      var _this2 = this;
...
var _ui = __webpack_require__(125);

var _codewriter = __webpack_require__(331);

var _github = __webpack_require__(332);

var _formsubmit = __webpack_require__(333);
...
function checkFormValidityAndSubmit(e) {
  if (e.target.classList.contains('needs-validation')) {
    e.target.addEventListener('blur', function () {
      return _formsubmit.formSubmit.checkInputValidity(e.target);
    });
  }
...
var Animation = function () {
  ...
  _createClass(Animation, [{
    ...
    // Fade out element
    value: function fadeOutElement(element, duration, callback) {
    ...
    key: 'fadeInElement',
    value: function fadeInElement(element, duration, callback) {
    ...
    key: 'slideInRight',
    value: function slideInRight(element, duration, callback) {
    ...
    key: 'slideOutRight',
    value: function slideOutRight(element, duration, callback) {
    ...
    key: 'slideInLeft',
    value: function slideInLeft(element, duration, callback) {
    ...
    key: 'slideOutLeft',
    value: function slideOutLeft(element, duration, callback) {
    ...
    key: 'slideInDown',
    value: function slideInDown(element, duration, callback) {
...
var animation = exports.animation = new Animation();
...
var CodeWriter = function () {
  ...
  _createClass(CodeWriter, [{
    ...
    value: function writeCode() {
      var finalTextArr = Array.from(this.finalText);
      var currentOutput = '';
      var inQuote = false;
      var iteration = 0;

      function _loopThroughText() {
        var char = finalTextArr[iteration];
    ...
    key: '_escapeHTML',
    value: function _escapeHTML(input) {
      var _this = this;
...
var codeWriter = exports.codeWriter = new CodeWriter();
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch('https://api.github.com/users/nasnyder91/repos?&sort=' + this.repos_sort + '&client_id=' + this.client_id + '&client_secret=' + this.client_secret);
...
var github = exports.github = new Github();
...
var FormSubmit = function () {
  ...
  _createClass(FormSubmit, [{
    ...
    key: 'showFormInvalid',
    value: function showFormInvalid(form) {
      var children = form.children;

      for (var i = 0; i < children.length; i++) {
        var input = children[i].querySelector('.needs-validation');
    ...
    key: 'makeInvalid',
    value: function makeInvalid(input) {
      input.classList.add('is-invalid');
    }
  }, {
    key: 'makeValid',
    value: function makeValid(input) {
...
var formSubmit = exports.formSubmit = new FormSubmit();
